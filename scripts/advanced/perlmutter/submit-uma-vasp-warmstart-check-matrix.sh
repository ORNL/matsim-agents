...
Example:
  ...
  scripts/advanced/perlmutter/submit-uma-vasp-warmstart-check-matrix.sh
EOF
  exit 0
fi
...
JOB_SCRIPT="${REPO_ROOT}/scripts/advanced/perlmutter/job-uma-vasp-warmstart-perlmutter.sh"
...
VASP_LAUNCHER="${MATSIM_VASP_LAUNCHER:-${REPO_ROOT}/scripts/launchers/perlmutter/run-vasp-gpu-perlmutter.sh}"
