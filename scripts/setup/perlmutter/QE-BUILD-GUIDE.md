...
```bash
QE_VERSION=7.4 bash scripts/setup/perlmutter/build-qe-gpu-perlmutter.sh
```

### Clean Rebuild (Remove Old Build)

```bash
CLEAN_BUILD=1 bash scripts/setup/perlmutter/build-qe-gpu-perlmutter.sh
```
...
```bash
CLEAN_BUILD=0 bash scripts/setup/perlmutter/build-qe-gpu-perlmutter.sh
```

### Increase Parallelism (on compute node)

```bash
NCORES=128 bash scripts/setup/perlmutter/build-qe-gpu-perlmutter.sh
```
...
QE_VERSION=7.4 \
bash scripts/setup/perlmutter/build-qe-gpu-perlmutter.sh
...
bash scripts/setup/perlmutter/build-qe-cpu-perlmutter.sh
```
