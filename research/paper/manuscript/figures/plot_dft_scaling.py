...
``deployments/perlmutter/jobs/submit-al-dft-scaling-sweep.sh`` (RUN_TAG
...
Run from ``research/paper/manuscript/figures``. Also prints the numbers cited in the text.
"""
...
def main() -> None:
    ...
    if not rows:
        raise SystemExit(
            ...
            "Submit deployments/perlmutter/jobs/submit-al-dft-scaling-sweep.sh first."
        )
