...
The `--system-site-packages` venv then falls back to the frameworks-provided
numpy 2.2.6 and pandas 3.0.0, which is exactly what every other C extension
in the stack expects.
