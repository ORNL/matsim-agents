...
#
# Submit:
#   sbatch deployments/frontier/jobs/job-qe-warmstart-frontier.sh
#
...
QE_LAUNCHER=${MATSIM_QE_LAUNCHER:-$REPO/deployments/frontier/launchers/run-pw-gpu-frontier.sh}
