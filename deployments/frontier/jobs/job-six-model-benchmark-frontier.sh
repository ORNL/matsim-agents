...
#   sbatch deployments/frontier/jobs/job-six-model-benchmark-frontier.sh
# ---------------------------------------------------------------------------
...
if [[ -z "${BENCHMARK_PROMPT:-}" ]]; then
  ...
  echo "Example:" >&2
  echo "  BENCHMARK_PROMPT='Propose a candidate inorganic material and justify expected stability.' sbatch deployments/frontier/jobs/job-six-model-benchmark-frontier.sh" >&2
  exit 2
fi
