...
# Aurora analog of `deployments/frontier/jobs/job-serve-multinode-frontier.sh`,
...
#   qsub deployments/aurora/jobs/job-serve-multinode-aurora.sh
#
# Submit (4 nodes, override model):
#   qsub -l select=4 \
#        -v MATSIM_MODEL_DIR=$PROJ/models/Mixtral-8x22B-Instruct-v0.1 \
#        deployments/aurora/jobs/job-serve-multinode-aurora.sh
# ---------------------------------------------------------------------------
