...
JOB_SCRIPT="${REPO_ROOT}/deployments/perlmutter/jobs/job-uma-warmstart-perlmutter.sh"
...
# Do NOT pass HF_TOKEN through sbatch --export to avoid leaking it into
# process listings and SLURM accounting logs.
