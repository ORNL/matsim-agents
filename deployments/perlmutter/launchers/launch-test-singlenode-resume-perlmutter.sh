...
#   bash deployments/perlmutter/launchers/launch-test-singlenode-resume-perlmutter.sh
#
...
PROJ="$(dirname "${REPO}")"
SMOKE="$REPO/deployments/perlmutter/smoke-tests/smoke-transformers-perlmutter.sh"
