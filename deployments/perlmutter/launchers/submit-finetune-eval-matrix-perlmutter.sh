...
#
# Usage:
#   bash deployments/perlmutter/launchers/submit-finetune-eval-matrix-perlmutter.sh
#
...
#   DRY_RUN=1 bash deployments/perlmutter/launchers/submit-finetune-eval-matrix-perlmutter.sh
#
