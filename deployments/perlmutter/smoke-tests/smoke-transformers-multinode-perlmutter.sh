...
#
# Submit:
#   sbatch -N 2 deployments/perlmutter/smoke-tests/smoke-transformers-multinode-perlmutter.sh
#
# Override model:
#   sbatch --export=ALL,MATSIM_MODEL_DIR=/path/to/model \
#          deployments/perlmutter/smoke-tests/smoke-transformers-multinode-perlmutter.sh
#
